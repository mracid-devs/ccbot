...
proxies = {
           'http': 'http://ehoxeyzp-rotate:222pxmymy6gn@p.webshare.io:80/',
           'https': 'http://ehoxeyzp-rotate:222pxmymy6gn@p.webshare.io:80/'
}
...
async def helpstr(message: types.Message):
    ...
    btns = types.InlineKeyboardButton("Bot Owner", url="t.me/uscarder_reborn")
